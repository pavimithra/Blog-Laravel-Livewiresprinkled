                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @foreach ($post->images as $images)
                                    @if($images->is_featured == 1)
                                        <img class=" h-20" src="{{ asset('/storage/'.$images->name) }}">
                                        @break
                                    @endif
                                @endforeach 
                            </td>
                            ...
                            <td class="gap-5">
                                <div class="flex gap-5">
                                    ...
                                    <form method="POST" action="{{ route('admin.posts.destroy', $post) }}" onsubmit="return confirm('{{ trans('Are you sure to delete') }}');" style="display: inline-block;">
                                        @csrf
                                        @method('delete')
                                        <button>
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
